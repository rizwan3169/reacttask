					...
					<div id="slider-carousel" className="carousel slide" data-ride="carousel">
						...
						<div className="carousel-inner">
							<div className="item active">
								...
								<div className="col-sm-6">
									<img src="assests/images/home/girl1.jpg" className="girl img-responsive" alt="" />
									<img src="assests/images/home/pricing.png"  className="pricing" alt="" />
								</div>
							</div>
							<div className="item">
								<div className="col-sm-6">
								...
								<div className="col-sm-6">
									<img src="assests/images/home/girl2.jpg" className="girl img-responsive" alt="" />
									<img src="assests/images/home/pricing.png"  className="pricing" alt="" />
								</div>
							</div>
							...
							<div className="item">
								...
								<div className="col-sm-6">
									<img src="assests/images/home/girl3.jpg" className="girl img-responsive" alt="" />
									<img src="assests/images/home/pricing.png" className="pricing" alt="" />
								</div>
							</div>
